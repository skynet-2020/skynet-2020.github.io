...
# V32: preserve V30's numeric field and raster structure exactly while
# replacing viridis with a continuous indigo-to-cherry palette.
...
render_fixed(field, file.path(output_dir, "25_v30-indigo-cherry-v32.png"))
render_fixed(
  aggregate_grid(field, 90L, 160L),
  file.path(study_dir, "25_v32_small-cells_160x90.png")
)
render_fixed(
  aggregate_grid(field, 45L, 80L),
  file.path(study_dir, "25_v32_medium-cells_80x45.png")
)
...
saveRDS(v30, file.path(output_dir, "25_v30-indigo-cherry-v32.rds"))

cat("V32 V30 indigo-to-cherry conversion complete\n")
