...
# V34: preserve V30's numeric field and raster structure exactly while
...
render_fixed(field, file.path(output_dir, "27_v30-warm-white-indigo-v34.png"))
render_fixed(
  aggregate_grid(field, 90L, 160L),
  file.path(study_dir, "27_v34_small-cells_160x90.png")
)
render_fixed(
  aggregate_grid(field, 45L, 80L),
  file.path(study_dir, "27_v34_medium-cells_80x45.png")
)
...
saveRDS(v30, file.path(output_dir, "27_v30-warm-white-indigo-v34.rds"))

cat("V34 V30 warm-white-to-indigo conversion complete\n")
